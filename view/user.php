        ...
        <div class="widget widget-nopad">
            ...
            <div class="widget-content">
                <div class="widget big-stats-container">
                    <div class="widget-content">
                        <h6 class="bigstats">Welcome to User Management Console, this is where you will perform all user related task</h6>
        ...
        <div class="widget">
            ...
            <div class="widget-content">
                <div class="shortcuts"> <a href="javascript:;" class="shortcut"><i class="shortcut-icon icon-list-alt"></i><span
                    ...
                    <a href="newuser" class="shortcut"><i class="shortcut-icon icon-user"></i><span class="shortcut-label">Users</span> </a>
