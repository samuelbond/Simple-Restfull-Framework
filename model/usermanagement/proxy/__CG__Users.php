...
class Users extends \Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Users' . "\0" . 'id', '' . "\0" . 'Users' . "\0" . 'userId', '' . "\0" . 'Users' . "\0" . 'username', '' . "\0" . 'Users' . "\0" . 'password', '' . "\0" . 'Users' . "\0" . 'status', '' . "\0" . 'Users' . "\0" . 'profile', '' . "\0" . 'Users' . "\0" . 'privilege');
        }
