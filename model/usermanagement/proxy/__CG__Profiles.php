 ...
 */
class Profiles extends \Profiles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Profiles' . "\0" . 'profileId', '' . "\0" . 'Profiles' . "\0" . 'firstName', '' . "\0" . 'Profiles' . "\0" . 'lastName', '' . "\0" . 'Profiles' . "\0" . 'street', '' . "\0" . 'Profiles' . "\0" . 'city', '' . "\0" . 'Profiles' . "\0" . 'postCode', '' . "\0" . 'Profiles' . "\0" . 'country', '' . "\0" . 'Profiles' . "\0" . 'phone1', '' . "\0" . 'Profiles' . "\0" . 'phone2');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Profiles $proxy) {
